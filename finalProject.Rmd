...
```{r}
# Fit models:
fit.lasso <- glmnet(trainTransformedMat, trainingDT$classe, family="multinomial", alpha=1)
#fit.ridge <- glmnet(trainTransformedMat, trainingDT$classe, family="multinomial", alpha=0)
#fit.elnet <- glmnet(trainTransformedMat, trainingDT$classe, family="multinomial", alpha=.5)
...
fit.lasso.cv <- cv.glmnet(trainTransformedMat, trainingDT$classe, type.measure="class", alpha=1, 
                          family="multinomial")
#fit.ridge.cv <- cv.glmnet(trainTransformedMat, trainingDT$classe, type.measure="class", alpha=0,
                          family="multinomial")
#fit.elnet.cv <- cv.glmnet(trainTransformedMat, trainingDT$classe, type.measure="class", alpha=.5,
                          family="multinomial")
